      ...
      <div className="p-4 md:p-8">
        ...
        {schedules.length === 0 ? (
          ...
          <motion.ul
            ...
            className="space-y-6 max-w-6xl mx-auto border-8 border-white p-6 pb-14 rounded-2xl shadow-lg bg-transparent"
          >
            <AnimatePresence>
              {schedules.map((schedule) => {
                ...
                return (
                  <motion.li
                    ...
                    className="p-6 border border-white rounded-xl shadow text-left bg-transparent"
                  >
                    <h2
